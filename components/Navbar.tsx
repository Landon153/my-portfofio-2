...
const contactLinks = [
	{
		label: "Email",
		href: "mailto:datnguyen2097@gmail.com?subject=Hello&body=Hello Landon,",
		icon: faEnvelope,
	},
	{
		label: "GitHub",
		href: "https://github.com/Landon153",
		icon: faGithub,
	},
	{
		label: "LinkedIn",
		href: "https://www.linkedin.com/in/dat-nguyen-landon-2a68b71b5/",
		icon: faLinkedin,
	},
	{
		label: "Instagram",
		href: "https://www.instagram.com/datthegioi?fbclid=IwY2xjawMLQyRleHRuA2FlbQIxMABicmlkETFMNGxVdDdjNHZMV0ZUU3hZAR6PTQRGRoXZDKhqi54YKl1K39sGOpumxgtANke5HjAGC6espg2plk5xnH-WBQ_aem_JD_52hvABws60j3NbEuJpg",
		icon: faInstagram,
		hideOnMobile: true,
	},
	{
		label: "Medium",
		href: "https://medium.com/@datnguyen2097",
		icon: faMedium,
		hideOnMobile: true,
	},
];
...
const NavItems = ({ isNavOpen, setIsNavOpen }: NavItemsProps) => {
	...
	const navVariant: Variants = isMobile
		? {
			open: {
					...
					<div className="flex items-center gap-1.5 md:gap-2">
						{contactLinks.map((item) => (
							<a
								...
								title={item.label}
								className={`flex h-8 w-8 items-center justify-center rounded-full transition-all duration-300 hover:scale-110 hover:bg-gray-200/60 ${
