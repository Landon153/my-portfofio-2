...
import Me4 from "@/public/image/me.jpeg";
import Me5 from "@/public/image/me1.jpg";
import Me6 from "@/public/image/me2.jpeg";
import BrickmateAward from "@/public/image/achievements/brickmate-year-end-award-2023.jpg";
...
export default function Education() {
	...
	const achievementsByYear = {
		2023: [
			{
				icon: faTrophy,
				title: "The Most Contributed Employee Of The Year 2023 Award (Brickmate)",
				subtitle: "Issued by Brickmate · Jan 2024",
				date: "Jan 2024",
				image: BrickmateAward,
				content:
					"The \"Most Contributed Employee of the Year 2023\" award at Brickmate recognizes outstanding dedication and excellence in the workplace. This prestigious award celebrates employees who have made significant contributions to the company's growth and success. The winner demonstrated exceptional skills, teamwork, and a commitment to achieving organizational goals throughout the year. Receiving this award highlights the recipient's hard work, innovation, and leadership qualities. By acknowledging and rewarding such remarkable achievements, Brickmate aims to inspire all employees to strive for excellence.",
			...
			<section className="grid gap-8 md:gap-12">
				...
				<motion.div
					...
					<p className="text-muted-foreground max-w-[800px] mx-auto">
						Get to know more about my educational background and achievements.
					</p>
				</motion.div>
				{/* Main Content */}
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					...
					<motion.div
						...
						<div className="font-medium text-lg mb-4">2016 - 2020</div>
						<div>
					...
					<motion.div
						...
						<p className="text-md font-normal mb-3 md:mb-6">
							Some of my achievements during my journey.
						</p>
											...
											<div className="bg-white/20 backdrop-blur-md border border-white/30 rounded-2xl p-4 shadow-lg hover:bg-white/30 transition-all duration-300 hover:shadow-xl grayscale hover:grayscale-0    ">
												{achievement.image && (
													<Image
														...
														className="mb-4 w-full rounded-xl border border-white/30 object-cover shadow-sm transition-transform duration-300 group-hover:scale-[1.01]"
													/>
												)}
