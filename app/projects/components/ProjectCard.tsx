...
const topAlignedThumbnailSlugs = new Set([
	"standage-logistic",
	"coucou",
	"vivid-plus",
	"prezem",
	...
	"ocmr",
	"payme-e-wallet",
	"metagalaxia-marketplace",
	"payme-merchant-dashboard",
	"sscc-sims",
]);

export default function ProjectCard({ project, index }) {
	const thumbnailPosition = topAlignedThumbnailSlugs.has(project.slug)
		? "center top"
		: "center center";
